...
export function Editar(){
    ...
    const ObtenerPersona = async () => {
        ...
        const response = await fetch(`${appsettings.url}Persona/Buscar/${id}`);
        ...
        if (response.ok) {
            ...
            Swal.fire({
                title:"Error",
                text:"No se puede obtener datos de la persona",
                icon:"warning"
            });
        }
    };
    ...
    const Guardar = async() => {
            ...
            const response = await fetch(`${appsettings.url}Persona/Editar/${id}`, {
                method:'PUT',
                headers:{
            ...
            if(response.ok){
                ...
                Swal.fire({
                    title:"Error",
                    text:"Error al editar la persona",
                    icon:"Warning"
                });
            }
                ...
                <Col sm={{size:8, offset:2}}>
                    ...
                    <Form>
                        <FormGroup>
                            ...
                            <input type="number" readOnly name="identificacion" onChange={inputChangeValue} value={Persona.identificacion}/>
                        </FormGroup>
                        <FormGroup>
                            <Label>Nombre</Label>
